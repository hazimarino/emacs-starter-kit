...
<Emacsはおおよそ真昼の太陽が星にそうであるのと同じように他のすべての編
集ソフトを上回ります。より大きく、より輝いているだけではなく、その他す
べてのものを消し去ります。>

-- Neal Stephenson, "In the Beginning was the Command Line"
<-- ニール・スティーヴンスン  "はじまりはコマンドラインから">
#+end_quote
...
Contact::hazimarino (Iyori Komiyama) <hazimarino@gmail.com>
...
<このセクションはEmacs Starter Kitが実装するすべてのコードが含まれています。>
...
*** ユビキタスパッケージ
Ubiquitous Packages <あちこちで使用されるパッケージ>

These should be loaded on startup rather than autoloaded on demand
since they are likely to be used in every session
<これらはあらゆるセッションのときに使用されると思われるので、要求に応
じてautoloadされるよりもむしろスタートアップでロードされるべきです。>
...
<Emacs 22でいくつかの機能が必要な場合のバックポートです>
#+srcname: starter-kit-emacs-22-helper
#+begin_src emacs-lisp 
  (require 'dominating-file)
#+end_src

*** starter-kit-* をロード/コンパイルするための関数
**** この関数は、starter-kit-*.org ファイルをロードするために使用されます
...
**** すべてのstarter-kitファイルをタングルし、バイトコンパイルします
